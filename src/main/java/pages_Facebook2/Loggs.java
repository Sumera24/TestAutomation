...
public class Loggs {
   public static Logger log= Logger.getLogger(Loggs.class.getName());
  // public static Logger log=LogManager.getLogger(Loggs.class.getName());
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		
		//PropertyConfigurator.configure("C:\\Users\\sumer\\eclipse-workspace\\Practice\\src\\main\\log4j.xml");
